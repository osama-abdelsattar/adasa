...
export default function Error() {
  return (
    <div className="py-15 min-h-[calc(100vh-5rem)] flex items-center justify-center relative overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="relative text-center px-4 max-w-lg mx-auto">
        ...
        <div className="relative w-28 h-28 mx-auto mb-8">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <i className="far fa-face-frown-open fa-3x text-orange-500"></i>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
          ...
          <a
            ...
            href="/blog"
          >
            <i className="far fa-newspaper transform rotate-y-180"></i>
            تصفح المقالات
          </a>
        </div>
