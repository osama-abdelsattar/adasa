...
export default function Newsletter() {
  return (
    <section
      id="newsletter"
      className="py-24 relative overflow-hidden bg-[rgb(10,10,10)]"
    >
        ...
        <div className="bg-[#161616] rounded-3xl border border-[#262626] p-8 md:p-12 lg:p-16 text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto mb-6">
            <input
              ...
              type="email"
            />
            <button className="px-8 py-4 bg-linear-to-r from-orange-500 to-orange-600 text-white font-semibold rounded-xl hover:from-orange-600 hover:to-orange-700 transition-all duration-300 cursor-pointer">
              اشترك الآن
            </button>
          </form>
